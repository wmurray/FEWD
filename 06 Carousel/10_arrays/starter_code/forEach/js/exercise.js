 ...
 */
var q1=new Array(1,2,3,4);
q1.forEach(addOneToNumbers)
function addOneToNumbers(element,index){
  q1[index]=element+1;
}
/**
* Question 2
...
*/
var q2=new Array("Will","Nevan","Jessica");
q2.forEach(funciton(element,index){
